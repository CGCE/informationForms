...
$db->query($sql);
$db=new db();
$db->query("SELECT max( id ) AS max FROM reservations");
$id=$db->result[0]['max'];

$message="Une nouvelle information a été enregistrée.<br/>Vous pouvez la consulter dans l'application \"Informations\" de l'intranet.";
$message.="<br/><br/><a href='http://intranet.reidhall.com/Informations/index.php?page=fiche.php&id=$id' target='_blank'>
http://intranet.reidhall.com/Informations/index.php?page=fiche.php&id=$id</a>";
